...
import domain.exception.InsertFailedException;
...
@Provider
public class InsertFailedExceptionMapper implements ExceptionMapper<InsertFailedException> {

    public Response toResponse(InsertFailedException exception) {
