...
@Provider
public class ConnectionFailedExceptionMapper implements ExceptionMapper<ConnectionFailedException> {

    public Response toResponse(ConnectionFailedException exception) {
