...
@Provider
public class DriverValidationExceptionMapper implements ExceptionMapper<DriverValidationException> {
    public Response toResponse(DriverValidationException exception) {
