...
@Provider
public class GeneralDatabaseExceptionMapper implements ExceptionMapper<GeneralDatabaseException> {

    public Response toResponse(GeneralDatabaseException exception) {
